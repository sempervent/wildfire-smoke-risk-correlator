-- Phase 7: extend alert candidates for parse errors, DLQ signals, consumer offsets.
...
AS $$
  ...
  SELECT
    ...
    CASE
      WHEN sp.spike_sum >= 40 THEN 'critical'
      WHEN sp.spike_sum >= 15 THEN 'warn'
      ELSE 'warn'
    END,
    NULL,
    NULL,
