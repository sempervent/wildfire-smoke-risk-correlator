-- Phase 10: risk calibration / evaluation hooks (scaffolding only).
...
COMMENT ON TABLE analytics.risk_observations IS 'External labels or proxy observations for offline evaluation — not validated science.';
...
COMMENT ON TABLE analytics.risk_model_evaluations IS 'Aggregated evaluation metrics vs risk_observations (engineering hook).';
